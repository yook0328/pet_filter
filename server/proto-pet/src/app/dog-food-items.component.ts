...
@Component({
  selector: 'pet-dog-food-items',
  templateUrl: './dog-food-items.component.html',
  styleUrls: ['./dog-food-items.component.css'],
  providers: [ PagerClass ]
  
})
export class DogFoodItemsComponent implements OnInit {

  page_no = 0;
  Items : DogFoodItem[] = [];
  ItemsStorage : DogFoodItem[] = [];
  url = this.dataService.getURL() + '/DogFood';
  pager: any = {};
