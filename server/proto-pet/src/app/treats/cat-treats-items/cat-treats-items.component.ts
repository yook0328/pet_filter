...
@Component({
  selector: 'pet-cat-treats-items',
  templateUrl: './cat-treats-items.component.html',
  styleUrls: ['./cat-treats-items.component.css'],
  providers: [ PagerClass ]
})
export class CatTreatsItemsComponent implements OnInit {

  page_no = 0;
  Items : DogFoodItem[] = [];
  ItemsStorage : DogFoodItem[] = [];
  url = this.dataService.getURL() + '/CatTreats';
  pager: any = {};
