    ...
    form.on('close',function(){
        ...
        var f01 = function(){
            return Promise.resolve(
                db.dog_food.findById(savedata.id).then(function(data){
        ...
        Promise.all([f01()]).then(function(result){
            ...
            var p01 = function(){
                return Promise.resolve(db.dog_food.update(row,
                    {
            ...
            Promise.all([p01(), delete01(), delete02(), delete03(), delete04() ]).then(function(result){
                ...
                var func02 = function(){
                    return savedata.nutritionalOption.split(',').reduce(function(p, ing) {
                        return p.then(function() {
                            if(ing.trim().length){
                                return db.dog_nutritional_option.create({ content_name: ing, dogFoodId: savedata.id });
                            }else{
                                return null;
                            }
                        });
                ...
                var func03 = function(){
                    return savedata.healthConsideration.split(',').reduce(function(p, ing) {
                        return p.then(function() {
                            if(ing.trim().length){
                                return db.dog_health_consideration.create({ content_name: ing, dogFoodId: savedata.id });
                            }else{
                                return null;
                            }
                        });
                ...
                var func04 = function(){
                        return savedata.ingredients.split(',').reduce(function(p, ing) {
                            return p.then(function() {
                                    return db.dog_ingredients.create({ content_name: ing, dogFoodId: savedata.id });
                            });
                        }, Promise.resolve())
                };
