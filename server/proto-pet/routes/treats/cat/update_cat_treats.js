    ...
    form.on('close',function(){
        ...
        var f01 = function(){
            return Promise.resolve(
                db.cat_treats.findById(savedata.id).then(function(data){
        ...
        Promise.all([f01()]).then(function(result){
            ...
            var p01 = function(){
                return Promise.resolve(db.cat_treats.update(row,
                    {
            ...
            Promise.all([p01(), delete01(),  delete04() ]).then(function(result){
                ...
                var func04 = function(){
                        return savedata.ingredients.split(',').reduce(function(p, ing) {
                            return p.then(function() {
                                    return db.cat_treats_ingredients.create({ content_name: ing, catTreatId: savedata.id });
                            });
                        }, Promise.resolve())
                };
